...
/**
 * The primary key class for the FCT_EIMR_ORD_COMP database table.
 * 
 */
@Embeddable
public class FctEimrOrdCompPK implements Serializable,CompoundedPKInterface {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FctEimrOrdCompPK)) {
			return false;
		}
		FctEimrOrdCompPK castOther = (FctEimrOrdCompPK)other;
		return 
