...
/**
 * The primary key class for the FCT_EIMR_ORDER database table.
 * 
 */
@Embeddable
public class FctEimrOrderPK implements Serializable, CompoundedPKInterface {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FctEimrOrderPK)) {
			return false;
		}
		FctEimrOrderPK castOther = (FctEimrOrderPK)other;
		return 
