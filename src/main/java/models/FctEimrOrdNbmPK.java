...
/**
 * The primary key class for the FCT_EIMR_ORD_NBM database table.
 * 
 */
@Embeddable
public class FctEimrOrdNbmPK implements Serializable, CompoundedPKInterface {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FctEimrOrdNbmPK)) {
			return false;
		}
		FctEimrOrdNbmPK castOther = (FctEimrOrdNbmPK)other;
		return 
