...
/**
 * The primary key class for the FCT_EIMR_MED_ADMIN database table.
 * 
 */
@Embeddable
public class FctEimrMedAdminPK implements Serializable,CompoundedPKInterface {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FctEimrMedAdminPK)) {
			return false;
		}
		FctEimrMedAdminPK castOther = (FctEimrMedAdminPK)other;
		return 
