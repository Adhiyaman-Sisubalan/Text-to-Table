...
/**
 * The primary key class for the FCT_EIMR_ORD_TRANS database table.
 * 
 */
@Embeddable
public class FctEimrOrdTranPK implements Serializable, CompoundedPKInterface {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FctEimrOrdTranPK)) {
			return false;
		}
		FctEimrOrdTranPK castOther = (FctEimrOrdTranPK)other;
		return 
