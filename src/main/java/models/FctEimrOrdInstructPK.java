...
/**
 * The primary key class for the FCT_EIMR_ORD_INSTRUCT database table.
 * 
 */
@Embeddable
public class FctEimrOrdInstructPK implements Serializable, CompoundedPKInterface {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FctEimrOrdInstructPK)) {
			return false;
		}
		FctEimrOrdInstructPK castOther = (FctEimrOrdInstructPK)other;
		return 
